...
export default function MailRowDisplay({ email }: { email: Email }) {
    return (
        <Flex
            ...
            align="center"
            p="2"
            className='hover:bg-zinc-800 flex-wrap border-b border-zinc-700'
        ...
        >
            <Flex align="center" justify="between" className='flex-grow'>
                ...
                <Flex gap="4">
                    <Text size="2" className='font-medium truncate' style={{ whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                        {email.subject.substring(0, 100)}
                    </Text>
                    <Text size="2" color="gray" className='text-gray-600 truncate' style={{ whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
